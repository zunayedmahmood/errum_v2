...
export default function CartSidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return createPortal(
    <div className="errum-storefront-portal" data-storefront-layer="cart-drawer">
      <div className={`ref-drawer-backdrop ${isOpen ? 'is-open' : ''}`} onClick={onClose} />
      <aside className={`ref-cart-drawer ${isOpen ? 'is-open' : ''}`} aria-hidden={!isOpen} aria-modal="true" role="dialog" aria-label="Shopping cart">
