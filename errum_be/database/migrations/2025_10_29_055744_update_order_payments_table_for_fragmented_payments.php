...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('order_payments', function (Blueprint $table) {
            ...
            $table->index(['is_partial_payment', 'installment_number'], 'op_partial_installment_idx');
            $table->index(['payment_type', 'payment_due_date'], 'op_type_due_date_idx');
            $table->index(['is_late_payment', 'days_late'], 'op_late_payment_idx');
        });
    }
