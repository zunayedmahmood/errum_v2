    ...
    <div className="ec-root min-h-screen bg-[var(--bg-root)]">
      ...
      <header className="relative py-16 md:py-24 border-b border-[var(--border-default)] bg-[var(--bg-depth)]">
        <div className="ec-container text-center relative z-10 ec-anim-fade-up">
          ...
          <h1 className="text-4xl md:text-6xl font-medium text-[var(--text-primary)] mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="lg:col-span-3 space-y-10">
            ...
            <div className="space-y-4">
              <h3 className="text-[11px] font-bold tracking-[0.25em] text-[var(--text-muted)] uppercase" style={{ fontFamily: "'Poppins', sans-serif" }}>Search</h3>
            ...
            <div className="hidden lg:block">
              ...
              <div className="mt-10 space-y-4">
                <h3 className="text-[11px] font-bold tracking-[0.25em] text-[var(--text-muted)] uppercase" style={{ fontFamily: "'Poppins', sans-serif" }}>Sort By</h3>
          ...
          <div className="lg:col-span-9">
            ...
            {isLoading ? (
              ...
              <div className="min-h-[500px] flex flex-col items-center justify-center text-center ec-surface py-20">
                ...
                <h3 className="text-2xl font-medium text-[var(--text-primary)] mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>No products found</h3>
