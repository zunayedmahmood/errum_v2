...
import cashSheetNewService, { CashSheetRow, CashSheetSummary } from '@/services/cashSheetNewService';
...
export default function CashSheetPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await cashSheetNewService.getSheet(month);
      setRows(res.data);
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 overflow-auto">
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            <div>
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Daily Cash Sheet New</h1>
