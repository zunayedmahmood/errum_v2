      ...
      const orderPayload = {
        ...
        items: itemsWithTax
          ...
          .map(({ item, taxAmount }) => {
            ...
            // ✅ Used/defective resale must be sent through the defective-resale path.
            // Otherwise the backend treats it as a normal stock sale and blocks it
            // after the item was moved to Extra Items Management.
            if (item.isDefective) {
